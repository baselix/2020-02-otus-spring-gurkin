...
class JournalUserRepositoryTest {
	...
	void getAllTest() {
		JournalUser journalUser1 = new JournalUser(1L, "user1");
		JournalUser journalUser2 = new JournalUser(2L, "user2");
	...
	void createAndGetTest() {
		JournalUser newJournalUser = new JournalUser(1L, "user1");
	...
	void findTest() {
		userRepository.save(new JournalUser(1L, LOGIN_FILTER));
	...
	void deleteTest() {
		JournalUser newJournalUser = userRepository.save(new JournalUser(1L,"user"));
		Long id = newJournalUser.getId();
