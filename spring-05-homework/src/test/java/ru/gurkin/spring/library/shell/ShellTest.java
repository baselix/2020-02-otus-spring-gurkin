...
class ShellTest {
	...
	private static final String ID_PARAM = " " + 1L;
	...
	private void init() {
		...
		when(authorService.getById(ArgumentMatchers.any(Long.class))).thenReturn(new Author());
		when(genreService.getById(ArgumentMatchers.any(Long.class))).thenReturn(new Genre());
		when(bookService.getById(ArgumentMatchers.any(Long.class))).thenReturn(new Book());
	}
	...
	void deleteGenreTest() {
		...
		verify(genreService, times(1)).delete(ArgumentMatchers.any(Long.class));
	}
	...
	void deleteAuthorTest() {
		...
		verify(authorService, times(1)).delete(ArgumentMatchers.any(Long.class));
	}
	...
	void deleteBookTest() {
		...
		verify(bookService, times(1)).delete(ArgumentMatchers.any(Long.class));
	}
