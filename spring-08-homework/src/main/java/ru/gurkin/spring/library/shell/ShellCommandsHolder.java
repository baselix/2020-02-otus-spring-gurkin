...
public class ShellCommandsHolder {
	...
	public String removeAuthor(@ShellOption() String bookId, @ShellOption() String authorId) {
		try {
			Book book = bookService.getById(bookId);
			Author author = authorService.getById(authorId);
	...
	public String removeGenre(@ShellOption() String bookId, @ShellOption() String genreId) {
		try {
			Book book = bookService.getById(bookId);
			Genre genre = genreService.getById(genreId);
	...
	public List<String> showComments(@ShellOption() String bookId) {
		List<String> result = Lists.newArrayList();
		Book book = bookService.getById(bookId);
		try {
			for(Comment comment : commentService.getCommentsByBook(book)) {
